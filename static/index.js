...
const templates = {
  A: {
    HD:
      "For Criteria A, Complex and self-authored demonstrates a strong comprehension of programming concepts covered in this class.",
    DI:
      "For Criteria A, Your original and self-authored code demonstrates a considered ability to comprehend, modify and integrate code.",
    CR:
      "For Criteria A, You have demonstrated an ability author and integrate code with sufficient comprehension of programming concepts covered in this class.",
    PS:
      "For Criteria A, Work demonstrates an ability to comprehend original code through the use of modified, integrated programming concepts covered in this class.",
    FA:
      "For Criteria A, Sumbitted code has not demonstrated an ability to author original code and/or the ability comprehend, modify or integrate code has not been demonstrated."
  },
  B: {
    HD:
      "For Criteria B, Strong interaction, layout and visual design to the level of professional standards.",
    DI:
      "For Criteria B, Well-considered interaction, layout and visual design.",
    CR:
      "For Criteria B, Mostly clear and adequately considered interaction, layout and visual design.",
    PS: "For Criteria B, Satisfying interaction design, layout and visual.",
    FA:
      "For Criteria B, Unclear, inadequate interaction, layout and visual design."
  },
  C: {
    HD:
      "For Criteria C, Excellent demonstration and solid understanding of the topics taught in the unit and clearly documented project that matches professional standards. Presented in an attractive and aesthetically pleasing format to an exceptional level of quality.",
    DI:
      "For Criteria C, Thorough demonstration and solid understanding of the topics taught in the unit and clearly documented project. Presented in an attractive and aesthetically pleasing format to a high-level of quality.",
    CR:
      "For Criteria C, Satisfying demonstration and understanding of the topics taught in the unit and well-documented project. Presented in an attractive and aesthetically pleasing format at a good level of quality.",
    PS:
      "For Criteria C, Some demonstration and understanding of the topics taught in the unit and mostly well-documented project. Presented in an attractive and aesthetically pleasing format at a satisfactory level of quality.",
    FA:
      "For Criteria C, Inadequate demonstration and understanding of the topics taught in the unit and missing and confusing project documentation. Poorly presented and formatted."
  }
};
...
function stop() {
  iframe.srcdoc =
    "<style>body {background-color: #eeeeee;}</style><body></body>";
}
...
function calculateMarks() {
  ...
  let num = Math.round(parseInt(markA.value, 10) + parseInt(markB.value, 10));
